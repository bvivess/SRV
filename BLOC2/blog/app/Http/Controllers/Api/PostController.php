...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        // $posts = Post::with(["category", "comments"])->paginate(3);  // post amb les taules relacionades, paginada
        $posts = Post::with(["category", "comments"])->get();  // post amb les taules relacionades, més óptima
