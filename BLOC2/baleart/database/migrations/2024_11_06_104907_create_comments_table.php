...
return new class extends Migration
{
    ...
    {
        DB::unprepared('DROP TRIGGER IF EXISTS update_scores_after_insert');
        DB::unprepared('DROP TRIGGER IF EXISTS update_scores_after_update');
        DB::unprepared('DROP TRIGGER IF EXISTS update_scores_after_delete');
